    ...
    (use-package mu4e
      ...
      (setq mu4e-maildir-shortcuts
            '(("/gmail/INBOX"               . ?i)
              ...
              ("/gmail/Starred" . ?f)))
      (setq mu4e-bookmarks
            '(("maildir:\"/gmail/All Mail\" flag:unread AND NOT flag:trashed"
               "Unread messages" 117)
              ("maildir:\"/gmail/All Mail\" date:today..now" "Today's messages" 116)
              ("maildir:\"/gmail/All Mail\" date:7d..now" "Last 7 days" 119)
