...
#+begin_src emacs-lisp :tangle tangle-init.el
  ...
  (defvar tx-variable-pitch-font (if (string= system-name "tim-desktop")
                                     (font-spec :family "Noto Sans")
                                   (font-spec :family "Fira Sans")))
  (defvar tx-serif-font (if (string= system-name "tim-desktop")
                            (font-spec :family "Noto Serif Display")
                          (font-spec :family "DejaVu Serif")))
