...
#+begin_src emacs-lisp :tangle tangle-init.el
  ...
  (defvar tx-variable-pitch-font (font-spec :family "Fira Sans"))
  (defvar tx-serif-font (font-spec :family "DejaVu Serif"))
...
#+begin_src emacs-lisp :tangle tangle-init.el
  ...
  ;;               'default-frame-alist
  ;;               (cons 'font
  ;;                     (cond ((stringp tx-font) tx-font)
  ;;                           ((fontp tx-font) (font-xlfd-name tx-font))
  ;;                           ((signal 'wrong-type-argument
  ;;                                    (list '(fontp stringp) tx-font)))))))
  ;;             ((display-graphic-p)
  ;;              (setq tx-font (face-attribute 'default :font))))
  ;;       (when tx-serif-font
  ;;         (set-face-attribute 'fixed-pitch-serif nil :font tx-serif-font))
  ;;       (when tx-variable-pitch-font
  ;;         (set-face-attribute 'variable-pitch nil :font tx-variable-pitch-font)))
  ;;   ((debug error)
  ;;    (if (string-prefix-p "Font not available: " (error-message-string e))
  ;;        (message "Could not find the '%s' font, falling back to system font"
...
#+begin_src emacs-lisp :tanble tangle-init.el
