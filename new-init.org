...
#+BEGIN_SRC emacs-lisp
  ...
  (if *is-a-mac*
      (progn
        (setq mu4e-lisp "/usr/local/Cellar/mu/0.9.18_1/share/emacs/site-lisp/mu/mu4e")
        (setq mu4e-info "/usr/local/Cellar/mu/0.9.18_1/share/info"))
  ...
  (use-package mu4e
    ...
    (setq mu4e-contexts
          `(,(make-mu4e-context
              ...
              (lambda (msg)
                (when msg
                  (mu4e-message-contact-field-matches msg :to tx-gmail-email)))
              :vars '((user-mail-address . tx-gmail-email)
            ...
            ,(make-mu4e-context
              ...
              (lambda (msg)
                (when msg
                  (mu4e-message-contact-field-matches msg :to tx-sheepcrc-email)))
              :vars '((user-mail-address . tx-sheepcrc-email)
                      (user-full-name . "Tim Cross")
            ...
            ,(make-mu4e-context
              ...
              (lambda (msg)
                (when msg
                  (mu4e-message-contact-field-matches msg :to tx-hotmail-email)))
              :vars '((user-mail-address . tx-hotmail-email)
                      (user-full-name . "Tim Cross")
                      (mu4e-compose-signature . (concat "Tim Cross\n"))
