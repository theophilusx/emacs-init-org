#+TITLE: Emacs init.el File (Speech-Dispatcher Version)
#+DATE: \today
#+AUTHOR: Tim Cross
* Load Path
...
* Speechd
  This version of my emacs init setup uses ~speechd.el~, part of the Speech
  Dispatcher system. It is similar to Emacspeak, but a lot simpler and less
  feature rich. Enable by running

  : M-x speechd-speak

  #+BEGIN_SRC emacs-lisp
    (add-to-list 'load-path "~/git/speechd-el")
