* Header
  ...
  ;; Filename: init.el
  ;; Last Modified: Thursday, 13 August 2015 01:45 PM AEST
  #+END_SRC
...
* EmacSpeak
  I have been using EmacsSpeak for about 18 years. For those unfamiliar with
    ...
    #+BEGIN_SRC emacs-lisp :tangle lisp/init-emacspeak.el
      (when (and (not noninteractive)
        ...
        (setq emacspeak-sounds-default-theme
              (concat *emacspeak-src-dir* "/sounds/3d/"))
        (add-hook 'emacspeak-startup-hook
                  (lambda ()
                    (dtk-set-rate tts-default-speech-rate 1)
                    (dtk-interp-sync)
